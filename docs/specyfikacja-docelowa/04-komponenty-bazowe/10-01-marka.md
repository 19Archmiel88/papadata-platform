...
„Marka” jest współdzielonym kontraktem, a nie lokalnym układem jednego ekranu. Wzorzec ma jedną odpowiedzialność, korzysta z fundamentów i komponentów bazowych oraz udostępnia warianty wymagane przez domeny bez kopiowania implementacji.
...
| --- | --- | --- | --- |
| 1 | logotyp | wymagany wariant lub stan | test Storybook + test interakcji |
| 2 | wariant jasny | wymagany wariant lub stan | test Storybook + test interakcji |
| 3 | wariant ciemny | wymagany wariant lub stan | test Storybook + test interakcji |
| 4 | symbol | wymagany wariant lub stan | test Storybook + test interakcji |
| 5 | nazwa produktu | wymagany wariant lub stan | test Storybook + test interakcji |
| 6 | znaki providerów | wymagany wariant lub stan | test Storybook + test interakcji |
| 7 | znaki statusów. | wymagany wariant lub stan | test Storybook + test interakcji |
