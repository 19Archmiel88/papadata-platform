...
export const capabilityCatalog:readonly CapabilityDescriptor[]=[
  ...
  descriptor("tenant.membership.read","tenant","medium",["GET /v1/settings/czlonkostwa","GET /v1/invitation/read"]),
  descriptor("tenant.membership.manage","tenant","critical",["POST /v1/auth/invitations/request","POST /v1/security/invitations/token","DELETE /v1/memberships/:id"],{approvalRequired:true}),
  ...
  descriptor("integrations.credentials.manage","workspace","critical",["POST /v1/integrations/:provider/test"],{approvalRequired:true}),
  ...
  descriptor("ai.action_proposal.execute","workspace","critical",["POST /v1/papa/ai-actions/execute","POST /v1/papa/ai-actions/rollback"],{approvalRequired:true}),
  descriptor("ai.governance.read","tenant","high",["GET /v1/papa/ustawienia-ai-i-governance"]),
  ...
  descriptor("privacy.deletion.approve","tenant","critical",["POST /v1/privacy/requests/:id/approve","POST /v1/privacy/identity-verifications"],{approvalRequired:true}),
  descriptor("privacy.audit.read","tenant","high",["GET /v1/customers/prywatnosc","GET /v1/customers/szczegoly-pseudonimizowane"]),
