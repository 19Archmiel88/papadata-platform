...
// Categorizes a metric code by its underlying canonical record type, returning
// the distinct provider ids behind that evidence. Order lines carry no
// providerId of their own -- it's resolved via the parent order.
