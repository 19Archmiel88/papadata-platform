...
component_id: SalesSources
---
# SalesSources

## Cel i odpowiedzialność
`SalesSources` rozwiązuje jeden określony problem interfejsu i nie przejmuje odpowiedzialności ekranu ani domenowego API. Kontrakt jest stanem docelowym wymagającym implementacji i testów.
...
`contracts/components/salessources.ts` re-eksportuje `SalesSourcesProps` z `contracts/domain-component-contracts.ts`; nie istnieje drugi konkurencyjny interfejs.
