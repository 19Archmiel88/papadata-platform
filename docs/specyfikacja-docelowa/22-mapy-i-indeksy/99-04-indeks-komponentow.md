...
| DataStatusBanner | status | ../04-komponenty-bazowe/komponenty/datastatusbanner.md |
...
| EvidencePanel | ai | ../04-komponenty-bazowe/komponenty/evidencepanel.md |
| RecommendationCard | ai | ../04-komponenty-bazowe/komponenty/recommendationcard.md |
