...
- SearchField
- Select
- Menu (lokalny sterownik sortowania)
- SegmentedControl
- Checkbox
- DataTable
- StatusBadge
...
| Lp. | Wymaganie | Kontrakt | Dowód odbioru |
| --- | --- | --- | --- |
| 1 | Wyszukiwanie / filtrowanie / sortowanie | Kontrolki zmieniają stan story i wynik DataTable; sortowaniem steruje lokalny sterownik złożony z Menu. | Storybook + fixture |
...
1. Play test sprawdza wyszukiwanie, filtr statusu, sortowanie, akcję wiersza, akcję zbiorczą oraz ustawienia widoku tabeli.
