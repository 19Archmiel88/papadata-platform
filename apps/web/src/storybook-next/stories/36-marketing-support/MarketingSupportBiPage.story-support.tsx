...
const meta = {
  title: 'INTERNAL STORY SUPPORT/WSPARCIE/Wsparcie w marketingu',
...
export const OverviewAndDistribution: Story = {
  name: 'Sekcje — Centrum wsparcia i rozkład spraw',
  render: () => (
    <StoryFrame>
      <MarketingSupportOverview />
    </StoryFrame>
...
export const WorkspaceMasterDetail: Story = {
  name: 'Sekcje — Sprawy i rekomendacje',
...
export const BriefWizard: Story = {
  name: 'Interakcje — Kreator briefu',
  render: () => <BriefHarness />,
  play: async ({ canvasElement }) => {
    const canvas = within(canvasElement);
...
export const OutcomesMeasurement: Story = {
  name: 'Sekcje — Wyniki i historia rekomendacji',
