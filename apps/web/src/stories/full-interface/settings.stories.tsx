...
const meta = {
  title: 'PapaData/100-settings/Ustawienia',
...
export const Default = story({ screenId: 'settings' }, 'Default');
export const Loading = story({ screenId: 'settings', state: 'loading' }, 'Loading');
export const Forbidden = story({ screenId: 'settings', state: 'forbidden' }, 'Forbidden');
...
export const Dark = story({ screenId: 'settings', theme: 'dark' }, 'Dark');
