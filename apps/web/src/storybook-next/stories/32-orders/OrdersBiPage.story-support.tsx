...
export const Lifecycle: Story = {
  name: 'Sekcje — Realizacja zamówień',
  render: () => (
    <StoryFrame>
      <OrdersLifecycleFlow />
    </StoryFrame>
...
export const Explorer: Story = {
  name: 'Sekcje — Eksplorator zamówień',
  render: () => (
    <StoryFrame>
      <OrderExplorer />
    </StoryFrame>
...
export const PaymentsAndShipping: Story = {
  name: 'Sekcje — Płatności i dostawa',
  render: () => (
    <StoryFrame>
      <OrdersPaymentsAndShipping />
    </StoryFrame>
