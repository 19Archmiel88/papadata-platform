...
const auditCards = [
  ...
  },
  {
    checks: [
      ...
      'copy mieści się w małych szerokościach',
    ],
  ...
  },
  {
    checks: [
      'line / area',
      'actual / plan / previous period / moving average',
      'focus i alternatywny opis poza geometrią',
    ],
  ...
  },
  {
    checks: [
      'bar / grouped / ranking',
      'benchmark i wartości ujemne',
      'czytelna oś i legenda na mobile',
    ],
  ...
  },
  {
    checks: [
      'donut / bar / stacked',
      'part-to-whole bez polegania wyłącznie na kolorze',
      'kompaktowa legenda',
    ],
  ...
  {
    checks: [
      'scatter / relationship / driver analysis',
  ...
  {
    checks: [
      'tooltip / hover / focus z klawiatury',
      'selection / date range / reset',
      'drill-down / cross-filtering bez zmiany sensu danych',
    ],
    ...
    <ChartFrame
      alternativeTable={(
        <table className="pd-a15-stage__table">
          <caption>
            Alternatywny odczyt danych dla finalnego passu dostępności
          </caption>
          <thead>
            <tr>
      ...
      businessQuestion="Czy sekcja 15 pozostaje czytelna w finalnym pass responsive i dostępności?"
      description="15.10 nie dodaje nowych funkcji. To kontrola desktop/tablet/mobile, light/dark, długich tekstów, legend, kontrastu i alternatywnego opisu danych."
      legend={(
        <span>
      ...
      rangeLabel="Desktop / tablet / mobile · 200% zoom"
      sourceLabel="Ownerzy 15.01–15.09"
      status="ready"
      statusLabel="Pass dostępności gotowy"
      summary={(
        <p>
          Finalny pass sprawdza regresje i spójność. Nie zmienia kontraktów
          znaczenia danych ani nie dodaje nowej interakcji.
        </p>
      )}
      title="Finalny pass sekcji 15 bez nowych funkcji"
      visualization={(
        <TrendChart
          ariaLabel="Trend kontrolny dla finalnego passu responsywności i dostępności"
          data={trendData}
          unit="Wynik jakości"
          valueFormatter={(value) => `${value} pkt`}
        />
      )}
      visualizationLabel="Trend kontrolny finalnego passu"
    />
  );
}
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          '15.10 jest finalnym passem responsive i dostępności dla sekcji 15. Nie dodaje nowych funkcji ani nowych właścicieli geometrii wykresów.',
      },
    },
  },
...
export const ChartAccessibilityReviewStory: Story = {
  ...
  render: () => (
    <StoryPresentationPage
      ...
      headerAside={(
        <StoryPresentationMeta
          ariaLabel="Parametry kontraktu finalnego passu"
          items={[
            { label: 'Kontrakt', value: '15.10' },
            { label: 'Zakres', value: 'responsive / a11y' },
      ...
      storyId="15.10"
      summary="Finalny pass po 15.03–15.09: desktop/tablet/mobile, light/dark, długie teksty, legendy, kontrast i alternatywny opis danych."
      title="Responsywność i dostępność"
    >
      <StoryPresentationSection
        index="01"
        summary="Macierz obejmuje ownerów 15.01–15.09 i sprawdza, że 15.10 tylko ujednolica oraz łapie regresje."
        title="Macierz finalnego passu"
      >
        <AuditMatrix />
      </StoryPresentationSection>
      ...
      <StoryPresentationSection
        index="02"
        summary="Jeden kontrolny ChartFrame z długim copy, legendą i tabelą alternatywną pokazuje oczekiwany układ finalnego passu."
        title="Próba reflow i a11y"
      >
