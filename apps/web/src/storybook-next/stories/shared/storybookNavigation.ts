...
const stories: Readonly<Record<string, string>> = {
  ...
  '/app/campaigns/przeglad': 'papadata-campaign-growth--overview',
  '/app/campaigns/lista-kampanii': 'papadata-campaign-growth--overview',
  ...
  '/app/customers': 'papadata-customer-portfolio--overview',
  '/app/traffic': 'papadata-traffic-portfolio--overview',
