...
export const localAuthFixturePasswords = {
  ...
  multiTenant: 'MultiOrgPassphrase123',
...
export const localAuthTenants: readonly Tenant[] = [
  {
...
export const localAuthMemberships: readonly Membership[] = [
  ...
  {
    membershipId: asMembershipId('mem_multi_ten_northstar'),
    tenantId: asTenantId('ten_northstar'),
    role: 'analyst',
    status: 'active',
    userId: asUserId('usr_multi_org'),
  ...
  {
    membershipId: asMembershipId('mem_multi_ten_baltic'),
    tenantId: asTenantId('ten_baltic'),
    role: 'analyst',
    status: 'active',
    userId: asUserId('usr_multi_org'),
